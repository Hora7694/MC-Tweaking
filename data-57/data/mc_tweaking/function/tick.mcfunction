...
execute as @e[type=minecraft:item] at @s if items entity @s contents minecraft:magma_cream if block ~ ~ ~ minecraft:water_cauldron run particle minecraft:smoke ~ ~ ~ 0.1 0 0.1 0 300 normal
execute as @e[type=minecraft:item] at @s if items entity @s contents minecraft:magma_cream if block ~ ~ ~ minecraft:water_cauldron run playsound minecraft:entity.generic.extinguish_fire ambient @a ~ ~ ~
...
execute as @e[type=minecraft:item] at @s if dimension minecraft:the_nether if items entity @s contents minecraft:wet_sponge unless block ~ ~-1 ~ #minecraft:air run playsound minecraft:entity.generic.extinguish_fire ambient @a ~ ~ ~
...
execute as @p if score @s mt.compas.toggle.display matches 1 run tellraw @s [{"translate":"mt.txt.compass_display.on","fallback":"Compass display has been toggled on","color":"yellow"}]
...
execute as @p if score @s mt.compas.toggle.display matches 3 run tellraw @s [{"translate":"mt.txt.compass_display.off","fallback":"Compass display has been toggled off","color":"yellow"}]
...
execute as @p if score @s mt.reco_compas.toggle.display matches 1 run tellraw @s [{"translate":"mt.txt.reco_compass_display.on","fallback":"Recovery compass display has been toggled on","color":"yellow"}]
...
execute as @p if score @s mt.reco_compas.toggle.display matches 3 run tellraw @s [{"translate":"mt.txt.reco_compass_display.off","fallback":"Recovery compass display has been toggled off","color":"yellow"}]
...
execute as @p if score @s mt.clock.toggle.display matches 1 run tellraw @s [{"translate":"mt.txt.clock_display.on","fallback":"Clock display has been toggled on","color":"yellow"}]
...
execute as @p if score @s mt.clock.toggle.display matches 3 run tellraw @s [{"translate":"mt.txt.clock_display.off","fallback":"Clock display has been toggled off","color":"yellow"}]
...
execute as @p if score @s mt.clock.toggle.format matches 1 run tellraw @s [{"translate":"mt.txt.clock_format.on","fallback":"Claock format has been set for 12h","color":"yellow"}]
...
execute as @p if score @s mt.clock.toggle.format matches 3 run tellraw @s [{"translate":"mt.txt.clock_format.off","fallback":"Claock format has been set for 24h","color":"yellow"}]
